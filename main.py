# -*- coding: utf-8 -*-
"""
Created on Sun Dec 19 13:09:58 2021
...
filenames=os.listdir("./dogs-vs-cats-dataset/train")
...
train_generator = train_datagen.flow_from_dataframe(train_df,
                                                 "./dogs-vs-cats-dataset/train/",x_col='filename',y_col='category',
...
test_generator = train_datagen.flow_from_dataframe(train_df,
                                                 "./dogs-vs-cats-dataset/test1/",x_col='filename',y_col='category',
                                                 target_size=Image_Size,
                                                 class_mode='categorical',
                                                 batch_size=batch_size)
...
test_filenames = os.listdir("./dogs-vs-cats-dataset/test1")
